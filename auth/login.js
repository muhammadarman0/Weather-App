    ...
    function handleSocialLogin(provider) {
        ...
        overlay.innerHTML = `
            <div class="glass-panel modal-content" style="padding: 30px; text-align: left; max-width: 380px; width: 90%;">
                <h3 style="margin-bottom: 10px; font-size: 1.5rem;"><i class="fa-brands fa-${provider.toLowerCase() === 'google' ? 'google' : 'facebook-f'}" style="margin-right: 8px;"></i>Sign in with ${provider}</h3>
